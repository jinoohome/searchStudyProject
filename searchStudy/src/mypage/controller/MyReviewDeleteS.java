...
/**
 * Servlet implementation class MyReviewUpdateS
 */
@WebServlet("/myrdel")
public class MyReviewDeleteS extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyReviewDeleteS() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0){
			response.sendRedirect("mreview?nickname=" + nickname +"&page="+ currentPage);
		}else{
